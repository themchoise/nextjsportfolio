  ...
  return (
    <div className="w-full flex justify-center items-center space-x-5 p-3  h-13 text-white">
      ...
      <div>
        ...
        <a target="_blank" href={'https://www.linkedin.com/in/maximiliano-joyce-254921125/'}> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 48 48">
      ...
      <div>
        ...
        <a target="_blank" href={'https://github.com/themchoise'}>
      ...
      <div>
        ...
        <a href="mailto: maximilianojoyce@gmail.com">
        <Image
      className ='object-contain'
      src="/email_542740.png"
      width={30}
      height={30}
